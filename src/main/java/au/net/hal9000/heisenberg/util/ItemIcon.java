...
public class ItemIcon implements Serializable {
   ...
   *
   * @param iconClosed the Icon to show when the container is closed.
   */
   ...
   * Set the Icon to draw when displaying this Item in the tree view.
   *
   * @param iconOpen the Icon to show when the container is open.
   */
   ...
   * Set the Icon to draw when displaying this Item in the tree view.
   *
   * @param iconLeaf the Icon to show when the non-container item is displayed.
   */
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + ((iconClosed == null) ? 0 : iconClosed.hashCode());
    result = prime * result + ((iconLeaf == null) ? 0 : iconLeaf.hashCode());
    result = prime * result + ((iconOpen == null) ? 0 : iconOpen.hashCode());
    return result;
  }
