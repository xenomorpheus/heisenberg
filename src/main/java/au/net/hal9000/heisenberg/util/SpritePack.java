...
public class SpritePack {
   ...
   *
   * @param spritePackFilename filename of sprite pack
   * @param width of one sprite
   * @param height of one sprite
   * @param rows in sprite pack
   * @param cols in sprite pack
   */
  public void init(String spritePackFilename, int width, int height, int rows, int cols) {
   ...
   *
   * @param number the position in the sprite pack, starting at zero for top left.
