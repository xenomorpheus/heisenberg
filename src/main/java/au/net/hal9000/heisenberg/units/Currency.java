 ...
 *
 * <p>Currency contains a whole number of pieces (coins) of each of the following: copper, silver,
...
public class Currency implements Serializable, Cloneable {
   ...
   *
   * @param pp Number of Platinum Pieces in this object.
   * @param gp Number of Gold Pieces in this object.
   * @param sp Number of Silver Pieces in this object.
   * @param cp Number of Copper Pieces in this object.
   */
  ...
  /**
   * Clones an exiting Currency object. Each can be independently modified later.
   *
   * @param otherCollection The Currency object being cloned.
   */
  public Currency(final Currency otherCollection) {
    this(otherCollection.pp, otherCollection.gp, otherCollection.sp, otherCollection.cp);
  }
   ...
   *
   * @param pp The number of platinum pieces.
   */
   ...
   *
   * @param gp The number of gold pieces.
   */
   ...
   *
   * @param sp The number of silver pieces.
   */
  ...
  /**
   * increment the current object by the argument currency. note that the currency arg is not
   * changed.
   *
  ...
  /**
   * convert into smallest number of coins. The number of coins will change in a purse. I consider
