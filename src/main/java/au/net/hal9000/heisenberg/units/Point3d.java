...
public class Point3d implements Serializable, Cloneable {
     ...
     */
    public final double distance(final Point3d other) {
    ...
    /** {@inheritDoc} */
    @Override
    public final Point3d clone() throws CloneNotSupportedException {
        final Point3d clone = (Point3d) super.clone();
        clone.x = x;
        clone.y = y;
        clone.z = z;
        return clone;
     ...
     * @return Point3d
     */
    public final Point3d duplicate() {
    ...
    /**
     * @return true if, and only if, either:<br>
     * <ol>
     * <li>equal in terms of double (NaN / +0 / -0 etc.)
     * <li>within tolerance of each other.
     * </ol>
     */
    private static boolean isEqualEnough(double a, double b, double tolerance) {
