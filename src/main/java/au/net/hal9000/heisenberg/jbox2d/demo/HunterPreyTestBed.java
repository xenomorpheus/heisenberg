...
class HunterPreyTestBed extends TestbedTest {
	...
	public void initTest(boolean deserialized) {
		...
		// Outer Boundary Walls
		{
			...
			// Learn boundary.
			hunterPreyAi.learnBarrierArray(boundary_shape, new Vec2(BARRIER_OFFSET_X, BARRIER_OFFSET_Y), "boundary");
		...
		// Internal Barrier "n" shape - three lines.
		{
			...
			hunterPreyAi.learnBarrierArray(barrier_shape, new Vec2(BARRIER_OFFSET_X, BARRIER_OFFSET_Y), "barrier");
