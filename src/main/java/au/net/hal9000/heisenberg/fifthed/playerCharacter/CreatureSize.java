...
public enum CreatureSize {
	...
	CreatureSize( int sizeModifier,int specialSizeModifier, int sizeModifierToFly, int sizeModifierToStealth, 
			double space, double naturalReach, String typicalHeightLength, String typicalWeight){
