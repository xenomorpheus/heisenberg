...
public interface ModelStateEvaluator {
  ...
  /**
   * Has the modelState been added to the list? This will be used to determine duplicates when
   * adding model states to the search fringe.
   *
   * @param addedModelStates list of places already visited.
   * @param modelState state of model.
   * @return true IFF agent has visited this location.
   */
  boolean isModelStateInAdded(List<ModelState> addedModelStates, ModelState modelState);
}
