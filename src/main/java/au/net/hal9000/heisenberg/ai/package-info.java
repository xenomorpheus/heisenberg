 ...
 * (Intelligent) Agent (IA) is an autonomous entity which observes through sensors and acts upon an
 * environment using actuators and directs its activity towards achieving goals.<br>
 ...
 * (Model State) Evaluator - A function to evaluate the State of the Model and give a value on how
 * good the model is e.g. the effort to get from the current state to reach the Goal State.
