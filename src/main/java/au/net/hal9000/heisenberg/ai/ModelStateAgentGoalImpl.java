...
public class ModelStateAgentGoalImpl implements ModelStateAgentGoal {
	...
	public ModelStateAgentGoalImpl duplicate() {
		return new ModelStateAgentGoalImpl(new Position(getAgentPosition()), new Position(getGoalPosition()));
	}
	...
	public String toString() {
		return getClass().getSimpleName() + "=[agent " + getAgentPosition() + ", goal " + getGoalPosition() + "]";
	}
