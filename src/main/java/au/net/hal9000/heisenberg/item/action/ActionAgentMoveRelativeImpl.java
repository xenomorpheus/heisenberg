 ...
 */
public final class ActionAgentMoveRelativeImpl extends ActionBase implements
        ActionAgentMoveRelative {
	...
	public boolean equals(Object obj) {
		...
		if (Double.doubleToLongBits(getCost()) != Double
				.doubleToLongBits(other.getCost()))
			return false;
