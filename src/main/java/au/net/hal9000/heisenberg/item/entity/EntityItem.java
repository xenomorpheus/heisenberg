...
public abstract class EntityItem extends ItemImpl implements StateEvaluation {
   ...
   *
   * <p>Call the reCalculateAllAbilityScores() function<br>
   ...
   *
   * @param newRecipes an array of Recipe IDs to add.
   */
   ...
   *
   * @param newSkills additional skills to set on Entity.
   */
   ...
   *
   * @param skill The freshly learnt Memory.
   */
