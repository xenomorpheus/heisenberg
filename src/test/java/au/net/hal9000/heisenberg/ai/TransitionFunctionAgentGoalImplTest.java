...
public class TransitionFunctionAgentGoalImplTest {
  ...
  public void testTransition() {
    ...
    ModelStateAgentGoalImpl modelState = new ModelStateAgentGoalImpl(agentPos, goalPos);
    ActionAgentMoveRelativeImpl action =
        new ActionAgentMoveRelativeImpl(Position.NORTH, Position.NORTH.length());
