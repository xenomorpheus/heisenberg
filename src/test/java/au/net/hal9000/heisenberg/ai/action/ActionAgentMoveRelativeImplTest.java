...
public class ActionAgentMoveRelativeImplTest {
  ...
  public void testEquals() {
    ...
    Action action1 = new ActionAgentMoveRelativeImpl(new Position(1, 2), 3.0f);
    Action action2 = new ActionAgentMoveRelativeImpl(new Position(1, 2), 3.0f);
    Action action2DiffPosition = new ActionAgentMoveRelativeImpl(new Position(4, 2), 3.0f);
    Action action2DiffCost = new ActionAgentMoveRelativeImpl(new Position(1, 2), 4.0f);
