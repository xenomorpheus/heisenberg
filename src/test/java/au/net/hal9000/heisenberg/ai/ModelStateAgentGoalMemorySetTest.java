...
public class ModelStateAgentGoalMemorySetTest {
  ...
  public void testGetGoalPosition() {
    ...
    ModelStateAgentGoalMemorySetImpl modelState =
        new ModelStateAgentGoalMemorySetImpl(agentPosition, goalPosition, memorySet);
  ...
  public void testDuplicate() {
    ...
    ModelStateAgentGoalMemorySetImpl modelState =
        new ModelStateAgentGoalMemorySetImpl(agentPosition, goalPosition, memorySet);
    // ModelState
    ModelStateAgentGoalMemorySetImpl newModelState =
        (ModelStateAgentGoalMemorySetImpl) modelState.duplicate();
    assertFalse("ensure a new ModelStateGoalMemorySet is created", modelState == newModelState);
    assertTrue("ensure new ModelStateGoalMemorySet equals() old", modelState.equals(newModelState));
  ...
  public void testHashCode() {
    ...
    ModelStateAgentGoalMemorySetImpl modelState2 =
        new ModelStateAgentGoalMemorySetImpl(agentPosition2, goalPosition2, memorySet);
