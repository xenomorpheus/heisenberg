...
/**
 * The class <code>ItemTreeCellRendererTest</code> contains tests for the class
 * {@link <code>ItemTreeCellRenderer</code>}
 *
...
public class ItemTreeCellRendererTest extends TestCase {
    ...
    public void testGetTreeCellRendererComponent() {
        ...
        Component result = fixture.getTreeCellRendererComponent(
            tree,
            value,
            sel,
            exp,
