...
public class ProductEntityPropertyTest {
  ...
  public void testGetPropertyName() {
    ProductEntityProperty property = new ProductEntityProperty("SomeId", "SomeProperty", 2.0f);
  ...
  public void testGetDescription() {
    ProductEntityProperty property = new ProductEntityProperty("SomeId", "SomeProperty", 2.0f);
    assertEquals("Id: SomeId type SomeProperty, delta is 2.0", property.getDescription());
  }
