...
public class ItemTest {
    ...
    public void testClone() {
        ...
        weightBase -= 1f;
        original.setWeightBase(weightBase);
        // TODO test just the property.
        // assertTrue("x.clone().equals(x) weightBase restored",clone.equals(original));
        ...
        original.setVolumeBase(volumeBase);
        // TODO test just the
        // property.assertTrue("x.clone().equals(x) volumeBase restored",clone.equals(original));
        ...
        if (valueBase != null) {
            ...
            // TODO test just the property.
            // assertTrue("x.clone().equals(x) valueBase restored",
    ...
    public void testCloneItem() {
        ...
        weightBase -= 1f;
        original.setWeightBase(weightBase);
        // TODO check the property. assertTrue("x.clone().equals(x) restored",
        // clone.equals(original));
        ...
        if (valueBase != null) {
            ...
            gp++;
            valueBase.setGp(gp);
            // TODO check the property. assertFalse("x.clone().equals(x)",
            // clone.equals(original));
            valueBase.setGp(gp - 1);
            // TODO check the property.
            // assertTrue("x.clone().equals(x) restored",
            // clone.equals(original));
        }
